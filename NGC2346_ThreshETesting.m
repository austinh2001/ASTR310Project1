A21 = rfits("C:\Users\Austin\Documents\GitHub\ASTR310Project1\Calibrated Images\2022-02-19\14in\Targets\NGC2346\ha\2022-02-19_calibrated_image_14in_NGC2346_ha.fit");
Ha_center_coordinates = [764,478];
Ha_semi_major_radius = 180;
Ha_semi_minor_radius = 100;
degrees_angle = -70;
noise_region = generateEllipticalRegion(A21.data,[1027,568],100,100);
z = 4;
egain = A21.egain;
